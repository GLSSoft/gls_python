...
from REST_wadiso import Model as activemodel
import matplotlib.pyplot as plt
import matplotlib.colors
from REST_abgis import AlbionGisLayer as abGis
...
def TestRoutine2():
    abGis.PrintLayerNames()
    abGis.PrintTableNames()
...
def TestModel():
    ...
    print(activemodel.ModelPath())
    
    print(activemodel.NodeTable().Info())
    print(activemodel.SourceTable().Info())
    print(activemodel.ValveTable().Info())
    print(activemodel.PipeTable().Info())
    print(activemodel.PumpTable().Info())
    print(activemodel.AppurtenanceTable().Info())

if __name__ == "__main__":
    
    #nodeTable = activemodel.NodeTable()
    #print(nodeTable.Name())
